...
namespace CardLoaderModCool
{
    ...
    {
        public void AddRepeater() //Evolves into Gatling Pea
        {
            List<CardMetaCategory> metaCategories = new List<CardMetaCategory>();
            List<Trait> traits = new List<Trait>();
            List<Texture> decals = new List<Texture>();
            List<Ability> abilities = new List<Ability>();
            EvolveIdentifier evolve = new EvolveIdentifier("GatlingPea", 1);
            ...
            decals.Add(tex2);
            NewCard.Add("Repeater", metaCategories, CardComplexity.Intermediate, CardTemple.Nature, "Repeater", 2, 2, description: "Repeater, the stronger sibling of a peashooter. It requires 4 energy!", cost: 0, energyCost: 4, appearanceBehaviour: appearanceBehaviour, abilities: abilities, evolveId: evolve, traits: traits, tex: tex, decals: decals);
        }
    }
}
