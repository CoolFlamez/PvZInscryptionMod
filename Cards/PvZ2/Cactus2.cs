...
namespace CardLoaderModCool
{
    public partial class Plugin
    {
        public void AddCactus2()
        {
            ...
            decals.Add(tex2);
            NewCard.Add("Cactus2", metaCategories, CardComplexity.Simple, CardTemple.Nature, "Cactus", 1, 5, description: "Pop some air units with the Cactus. It requires 2 energy!", cost: 0, energyCost: 2, appearanceBehaviour: appearanceBehaviour, abilities: abilities, tex: tex, decals: decals);
        }
    }
}
